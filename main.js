...
function reveal() {
  var reveals = document.querySelectorAll(".parallax-effect");

  for (var i = 0; i < reveals.length; i++) {
    var windowHeight = window.innerHeight;
    var elementTop = reveals[i].getBoundingClientRect().top;
    var elementVisible = 150; // Distance from bottom of the viewport to start revealing

    // Check if the element is within the visible area of the viewport
    if (elementTop < windowHeight - elementVisible) {
      reveals[i].classList.add("active"); // Add the active class to make it visible
    } else {
      reveals[i].classList.remove("active"); // Remove the active class to hide it again
    }
  }
}
...
document.addEventListener("DOMContentLoaded", function () {
  reveal(); // Call the reveal function initially to check the visibility of elements on page load
});

function revealRight() {
  var reveals = document.querySelectorAll(".parallax-effect-left");
  ...
  for (var i = 0; i < reveals.length; i++) {
    ...
    // Check if the element is within the visible area of the viewport
    if (elementTop < windowHeight - elementVisible) {
      reveals[i].classList.add("active-left"); // Add the active class to make it visible
    } else {
      reveals[i].classList.remove("active-left"); // Remove the active class to hide it again
    }
  }
}
...
document.addEventListener("DOMContentLoaded", function () {
  revealRight(); // Call the reveal function initially to check the visibility of elements on page load
});

function revealLeft() {
  var reveals = document.querySelectorAll(".parallax-effect-right");
  for (var i = 0; i < reveals.length; i++) {
    var windowHeight = window.innerHeight;
    var elementTop = reveals[i].getBoundingClientRect().top;
...
document.addEventListener("DOMContentLoaded", function () {
  revealLeft(); // Call the reveal function initially to check the visibility of elements on page load
});
